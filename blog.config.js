...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || 'e62ba2f7e9e14cc780cc77bda32da9a8',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'GNight1989', // 您的昵称 例如 tangly1024
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: '\'39',
      artist: 'Queen',
      url: 'https://music.163.com/song/media/outer/url?id=1868734.mp3',
      cover:
        'http://p2.music.126.net/GiqUqEhBzdz9FqEB0j5BVA==/1688849860264729.jpg'
    },
  ],
